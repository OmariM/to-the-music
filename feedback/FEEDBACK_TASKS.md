# Website Feedback Tasks

Sources: `desktop-website-feedback.md`, `mobile-website-feedback.md`

---

## 🎨 Branding & Visual Design

- [ ] **Match fonts from the Canva design** — figure out what fonts Val uses and apply them to the site
- [ ] **Match logo gradient in the color scheme** — pull colors from the logo icon and integrate across the site (hero title gradient, accents, etc.)
- [ ] **Hero background video** — replace static background with a video in the hero section
